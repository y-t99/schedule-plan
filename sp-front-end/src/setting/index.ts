import type { ThemeSettings } from '../interface/theme';
import { EnumAnimate, EnumMultiTabMode, EnumHorizontalMenuPosition } from '../enum/theme';
...
const themeSettings = (customThemeSettings as ThemeSettings) || defaultThemeSettings;
