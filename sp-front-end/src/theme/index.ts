...
import { themeSettings, defaultThemeSettings } from '../setting';
import type { ThemeSettings, NavMode, MultiTabMode, AnimateType, HorizontalMenuPosition } from '../interface/theme';
